...
if isUseExampleImage    
    ...
    path = '/home/tanvirdell3/Downloads/caserel-master/Publically available Dataset/Extracted frames for Segementation/Control';
    [filename, folderPath , filterindex] = uigetfile([path '*.png' ],'Pick some images','MultiSelect', 'on');
